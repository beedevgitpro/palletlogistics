    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 footer-copyright">
                <p class="mb-0">Copyright 2020 © Pallet Logistics All rights reserved.</p>
            </div>
            <div class="col-md-6">
                <p class="pull-right mb-0">Design & Developed By Pallet Logistics <i class="fa fa-heart"></i></p>
            </div>
        </div>
    </div>
</footer>
...
<script src="<?php echo base_url('assets/js/dashboard/dashboard-ecommerce/chart.custom.js') ?>"></script>
<script src="<?php echo base_url('assets/js/dashboard/dashboard-ecommerce/morris-script.js') ?>"></script>
<script src="<?php echo base_url('assets/js/dashboard/dashboard-ecommerce/owl-carousel.js') ?>"></script>
...
<script src="<?php //echo base_url('assets/js/theme-customizer/customizer.js')
                ?>"></script>
<!-- Plugin used-->

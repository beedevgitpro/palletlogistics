    ...
    html += '<td></td>';
     ...
     var typ = new Array();
      ...
      html += '<td><input type="checkbox" name="cb1"  id="'+data[count].metaid+'" class="chb btn btn-xs btn-info cha_id"></td>';
          html += '<td  data-row_id="'+data[count].metaid+'" data-column_name="Date" class="table_datass"  id="Date'+data[count].metaid+'" contenteditable>'+data[count].movements_date+'</td>';
          html += '<td  data-row_id="'+data[count].metaid+'" data-column_name="equipment"    contenteditable><select  class=" table_drop form-control equipment'+count+'" id="equipment'+data[count].metaid+' "><?php foreach($result as $rowss) { ?> <option  value="<?php echo $rowss->equipment_id; ?>"><?php echo $rowss->equipment; ?></option> <?php } ?></select> </td>';
          ...
          html += '<td data-row_id="'+data[count].metaid+'" data-column_name="Transaction" contenteditable><select class=" table_drop3 form-control transaction'+count+'" id="Transaction'+data[count].metaid+'"><?php foreach($transaction as $rowt) { ?> <option value="<?php echo $rowt->transaction_id; ?>"><?php echo  $rowt->transaction; ?></option> <?php } ?></select></td>';
          html += '<td  data-row_id="'+data[count].metaid+'"  class="effectives" data-column_name="Effective_date" id="Effective_date'+data[count].metaid+'" contenteditable>'+data[count].effective_date+'</td>';
       ...
       html += '<td  data-row_id="'+data[count].metaid+'" data-column_name="Carrier"  id="carrierlists'+data[count].metaid+'" contenteditable></td>';
          ...
          html += '<td  data-row_id="'+data[count].metaid+'" data-column_name="type" contenteditable><select class=" type form-control type'+count+'" id="Type'+data[count].metaid+'"><?php foreach($type as $rowtt) {  ?> <option value="<?php echo $rowtt->type_id; ?>"><?php echo $rowtt->type; ?></option> <?php } ?></select></td>';
          ...
          html += '<td  data-row_id="'+data[count].metaid+'" data-column_name="Batch" class="batchs" id=" Batch'+data[count].metaid+'" contenteditable>'+data[count].batch+'</td>';

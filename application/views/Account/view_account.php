...
$('#pagination').on('click','a',function(e){
...

  {
    ...
    //  url:"<?php echo base_url(); ?>livetable/load_data",
      ...
      url:"<?php echo base_url('User/view_accountss/')?>"+pagno,
      ...
      success:function(datas){
        ...
        var randomnumber = Math.floor(Math.random() * (maxNumber + 1) + minNumber); 
           ...
           html += '<tr>';
            html+='<td hidden ><input hidden id="login'+randomnumber+'" type="text" class="ids'+data[count].metaid+'" value="'+data[count].login_id+'"></td>';

...
function Userright(data)
	{
		var name=data.value;
		alert(name);
		$('#bp').load('<?php echo base_url("User/getData")?>',{"us":name});
	}
function Userrights(data)
	{
		var name=data.value;
		alert(name);
		$('#bps').load('<?php echo base_url("User/getData")?>',{"use":name});
	}
</script> 
 ...
 <section class="content">
	 ...
	 <div class="box-body">
	 <form method="post" action="<?php echo base_url('User/insert_assign_role');?>">
	<div class="row">
        ...
        <div class="row">
            <div class="col-md-4" style="">
                <div class="hpanel ">
                    <div class="panel-body">
                        ...
                        <select id="bp" size="10" multiple="multiple" class="box form-control" name="left_select[]" style="overflow: auto"></select>
                        </div>    
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="hpanel">
                    <div class="panel-body">
                         <div class="text-center well">
                        <select id="bps" class="form-control box" size="10" multiple="multiple" name="right_select[]" style="overflow: auto; ">

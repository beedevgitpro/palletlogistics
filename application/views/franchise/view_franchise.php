							...
							<div class="col-xs-12">
								<div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="<?php echo base_url('User/dashboard')?>">Franchise</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url('User/view_franchise')?>">View Franchise </a>
                                        </li>
                        ...
                        <!-- end row -->
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <h4 class="m-t-0 header-title"><b>View Franchise</b></h4>
                                    ...
                                    <table id="datatable-keytable" class="table table-striped  table-colored table-info">
										...
										<?php
										$c=1;
										$result=$this->User_Model->get_franchise();
                                        ...
                                        <tr>
											...
											<?php
											 $stateId=$row->state;
											$result1=$this->User_Model->get_state_detail($stateId);

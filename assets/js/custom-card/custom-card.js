var customcard = {
    init: function() {
        $(".card-header-right .close-card").on('click', function() {
            ...
            $this.parents('.card').append('<div class="loader-box card-loader"><div class="loader card-load"><div class="loader"><div class="line bg-primary"></div><div class="line bg-primary"></div><div class="line bg-primary"></div><div class="line bg-primary"></div></div></div></div>');
            setTimeout(function() {
